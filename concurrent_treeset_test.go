...
func TestConcurrentTreeSet_CoverageSupplement(t *testing.T) {
	...
	// String
	str := s.String()
	require.Contains(t, str, "concurrentTreeSet") // camelCase implied
	...
	require.True(t, s2.IsSupersetOf(s1))
	require.True(t, s1.IsProperSubsetOf(s2))
	require.True(t, s2.IsProperSupersetOf(s1))
	...
	require.True(t, s2.Any(func(e int) bool { return e == 2 }))
	require.True(t, s2.Every(func(e int) bool { return e > 0 }))
